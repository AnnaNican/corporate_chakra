    ...
    return Container(
      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          DateCardWidget('Praise Your Team', 'On international passive-agressive compliments day!', Icons.cake, 'June 1, 2020', 'Compliments are sooo 1-sided. Give your employees the full picture by working insults into your compliments. "Amazing, job with the new marketing campaign, Bill. I\'ve never seen anything like it! You\'ve lost us 8% of our current subscribers." "Martha, great work with the sign up button. 1 in 3 people can\'t even find it."'),
